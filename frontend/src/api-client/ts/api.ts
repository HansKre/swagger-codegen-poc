...
export const PetApiFp = function (configuration?: Configuration) {
  return {
    ...
    deletePet(
      ...
      const localVarFetchArgs = PetApiFetchParamCreator(configuration).deletePet(
        petId,
        apiKey,
        options
      )
    ...
    findPetsByStatus(
      ...
      const localVarFetchArgs = PetApiFetchParamCreator(configuration).findPetsByStatus(
        status,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
    ...
    updatePetWithForm(
      ...
      const localVarFetchArgs = PetApiFetchParamCreator(configuration).updatePetWithForm(
        petId,
        name,
        status,
        options
    ...
    uploadFile(
      ...
      const localVarFetchArgs = PetApiFetchParamCreator(configuration).uploadFile(
        petId,
        additionalMetadata,
        file,
        options
...
export const StoreApiFp = function (configuration?: Configuration) {
  return {
    ...
    deleteOrder(
      ...
      const localVarFetchArgs = StoreApiFetchParamCreator(configuration).deleteOrder(
        orderId,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
    ...
    getInventory(
      options?: any
    ): (fetch?: FetchAPI, basePath?: string) => Promise<{ [key: string]: number }> {
    ...
    getOrderById(
      ...
      const localVarFetchArgs = StoreApiFetchParamCreator(configuration).getOrderById(
        orderId,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
...
export const UserApiFp = function (configuration?: Configuration) {
  return {
    ...
    createUsersWithArrayInput(
      ...
      const localVarFetchArgs = UserApiFetchParamCreator(configuration).createUsersWithArrayInput(
        body,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
    ...
    deleteUser(
      ...
      const localVarFetchArgs = UserApiFetchParamCreator(configuration).deleteUser(
        username,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
    ...
    getUserByName(
      ...
      const localVarFetchArgs = UserApiFetchParamCreator(configuration).getUserByName(
        username,
        options
      )
      return (fetch: FetchAPI = isomorphicFetch, basePath: string = BASE_PATH) => {
    ...
    loginUser(
      ...
      const localVarFetchArgs = UserApiFetchParamCreator(configuration).loginUser(
        username,
        password,
        options
      )
    ...
    updateUser(
      ...
      const localVarFetchArgs = UserApiFetchParamCreator(configuration).updateUser(
        body,
        username,
        options
      )
...
export class UserApi extends BaseAPI {
  ...
  public createUsersWithArrayInput(body: Array<User>, options?: any) {
    return UserApiFp(this.configuration).createUsersWithArrayInput(body, options)(
      this.fetch,
      this.basePath
    )
  }
  ...
  public createUsersWithListInput(body: Array<User>, options?: any) {
    return UserApiFp(this.configuration).createUsersWithListInput(body, options)(
      this.fetch,
      this.basePath
    )
  }
